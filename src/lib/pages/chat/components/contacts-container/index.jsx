...
export default ContactsContainer;
  ...
  return (
    <div className="flex p-5 justify-start items-center gap-2">
      ...
      >
        {""}
        <path d="M55.5 0H77.5L5B.5 32H36.5L55.5 0Z"
        className="ccustom"
        fill="#8338ec">
        </path> {""}

        <path d="M35.5 0H51.5L32.5 32H16.5L55.5 0Z"
        className="ccompli1"
        fill="#975aed">
        </path>{""}
      ...
      <span className="text-3xl font-semibold text-white">Vivid</span>
    </div>
  );
};
...
const Title = ({text}) => {
  return (
    <h6 className="uppercase tracking-widest text-neutral-400 pl-10 text-lg font-light text-opacity-90 mb-4">
      {text}
    </h6>
  );
}
